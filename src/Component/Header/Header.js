    ...
    return (
        <div style={{marginBottom:'10px'}}>
                <nav className="navbar navbar-light" style={{backgroundColor: "#e3f2fd"}}>
                    <div >
                        <h1>
                            <a href="#" style={{color:'black', textDecoration:'none'}}>Odami Course</a>
                        </h1>
                    </div>
                    <a href="#" style={{textDecoration:'none'}} className='hoverable'><small>Catagories</small></a>
                    <form className="form-inline my-2 my-lg-0 optional800">
                    ...
                    <a href="#" style={{textDecoration:'none'}} className='optional1100'><small>Odami for Teachers</small></a>
                    <a href="#" style={{textDecoration:'none'}} className='optional1100'><small>Odami for Students</small></a>
                    <form>
